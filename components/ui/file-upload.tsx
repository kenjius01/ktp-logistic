...
import { EyeIcon, Trash2 as RemoveIcon } from 'lucide-react';
...
export const FileUploaderItem = forwardRef<
  HTMLDivElement,
  { index: number; onRemove: (id: number) => void } & React.HTMLAttributes<HTMLDivElement>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'group relative h-6 cursor-pointer justify-between p-1',
        className,
        isSelected ? 'bg-muted' : '',
      )}
      {...props}
