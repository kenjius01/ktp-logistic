  ...
  'col-start-2 col-end-3 row-start-1 row-end-1 flex  items-center justify-center rounded-full border border-current',
  {
    variants: {
      status: {
        ...
        done: 'bg-mainColor [&>*:not(.lucide-check)]:hidden [&>.lucide-check]:text-background',
        error:
  ...
  ({ className, done = false, ...props }, ref) => {
    return (
      <hr
        ...
        className={cn(
          'col-start-2 col-end-3 row-start-2 row-end-2 mx-auto flex h-full w-0.5 justify-center rounded-full',
